...
<div class="header hidden-gt-sm tw-p-[10px]" style="background:var(--header-gradient)">
    <a href="{!! BASE_URL !!}" target="_blank">
        <img src="/dist/images/logo-lean-tool.png" class="tw-h-full "/>
    </a>
</div>
...
<div class="row" style="min-height:100vh; max-width: 98vw; height: auto;">
    <div class="col-md-4 hidden-phone regLeft">
        ...
        <div class="logo">
            <a href="{!! BASE_URL !!}" target="_blank">
                <img src="/dist/images/logo-lean-tool.png" />
            </a>
        </div>
            ...
            <div class="regpanelinner">
                ...
                @if($logoPath != '')
                    <a href="{!! BASE_URL !!}" target="_blank">
                        ...
                        @if(!str_ends_with($logoPath, "dist/images/logo-lean-tool.png" ))
    ...
    <div class="leantimeLogo">
        <span style="font-size: 12px; color: var(--text-muted);">Powered by Lean Tool</span>
    </div>
</div>
